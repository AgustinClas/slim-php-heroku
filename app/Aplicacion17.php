...
*/
    ...
    $auto3 = new Auto("Fiat", "Azul", 100);
    $auto4 = new Auto("Fiat", "Azul", 200);

    $auto5 = new Auto("Ford", "Marron", 300, getDate());

    $auto3->AgregarImpuestos(1500);
    $auto4->AgregarImpuestos(1500);
    $auto5->AgregarImpuestos(1500);

    echo ClaseAutos::Add($auto1, $auto2);

    if($auto1->Equals($auto2))
        echo "\n El auto 1 y el auto 2 son iguales \n";
    else 
        echo "\n El auto 1 y el auto2 no son iguales \n";
